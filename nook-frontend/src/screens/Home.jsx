...
function Home() {
  ...
  const goToAbout = () => {
    navigate('/about'); // This will take user to the about page
  };

  // Function to navigate to menu page
  const goToMenu = () => {
    navigate('/menu'); // This will take user to the menu page
  };

  // Function to navigate to contact page
  const goToContact = () => {
    navigate('/contact'); // This will take user to the contact page
  };
